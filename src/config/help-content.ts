...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: '5. Examples for your mailbox', description: 'The grid of chips (2@…, 3@…, 5@…, 7@…, 10@…, 14@…, 21@…, 30@…) shows ready-to-copy BCC addresses for your domain. Any number ≥ 2 works — pick the one that matches how long you are willing to wait.' },
      { title: '6. When the due date arrives — Always: move to category', description: 'On the due date, the original email is ALWAYS labeled and moved into your No Reply Tracker category so it surfaces in your inbox audit. This row is locked ON ("Always On") because it is the core of the feature — it cannot be turned off.' },
      { title: '7. Auto Draft a follow-up (toggle)', description: 'When green, InboxIQ writes a polite, on-brand nudge and saves it as a real draft in your Outlook Drafts folder — you review and click Send. Turn this off if you want to write the nudge yourself.' },
      { title: '8. Auto Reply — sends automatically (toggle)', description: 'When green, InboxIQ writes AND SENDS the follow-up for you without review. The yellow warning ("Replies will be sent without your review") is there for a reason — use this for low-risk threads only. Auto Reply requires Auto Draft to be on first.' },
      { title: '9. Lifecycle & how to stop a tracker', description: 'Four ways a tracker ends:\n• Reply received — the recipient answered, tracker clears itself and the email leaves the No Reply Tracker category.\n• Auto-stop after 3 nudges — InboxIQ stops on its own after the 3rd reminder; the email stays in the category so you can decide manually.\n• Manual stop via BCC — reply on the thread with BCC stop@yourdomain.com or 0@yourdomain.com to cancel immediately and move the original message back to the inbox.\n• Re-arm anytime — sending a fresh email on the thread with a numeric BCC starts a brand-new tracker with a fresh due date and fresh reminder count.' },
      { title: '10. Business hours — master toggle', description: 'The green switch on the Business hours card limits Auto Draft, Auto Reply, and the daily auto-audit to your working hours. Outside those hours, emails are still moved to your No Reply Tracker category — only the drafts and sends wait. This toggle is locked ON while No Reply Tracker is active so nudges never fire at 2am.', target: '[data-tour="followup-hours-toggle"]' },
      { title: '11. Start / End / Timezone', description: 'Pick the local Start and End time of your workday and the timezone they apply to. Timezone is auto-detected from Outlook on first run and falls back to your computer. The "Use mine" button instantly sets the timezone to your browser/computer setting.' },
      { title: '12. Business days', description: 'Click any day pill (Sun – Sat) to include or exclude it. Selected days are blue. The "Current window" line at the bottom shows the exact rule InboxIQ will follow (e.g. "8:00 AM – 5:00 PM (America/Los_Angeles)").' },
