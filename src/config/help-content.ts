...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    intro:
      'The AI Chat is your conversational co-pilot. Each chat keeps its own memory, you can attach files, dictate by voice, and switch on deep research or live web search per message.',
    steps: [
      { title: '1. Start a new chat', description: 'Use New chat in the left sidebar whenever you want a clean conversation. Old chats are saved and searchable in the history below it.', target: '[data-tour="chat-new"]', route: '/ai-chat' },
      { title: '2. Watch your capacity', description: 'This meter tracks how much room is left in the current chat. When it gets full, click Summarize & continue and we will move you to a fresh chat with the context preserved.', target: '[data-tour="chat-capacity"]' },
      { title: '3. Attach a file', description: 'Drop PDFs, screenshots, Word docs or text files in here. The assistant reads them and can answer questions about their contents.', target: '[data-tour="chat-attach"]' },
      { title: '4. Talk instead of type', description: 'Click the microphone to dictate. Speak naturally — your words are transcribed and dropped into the message box automatically.', target: '[data-tour="chat-mic"]' },
      { title: '5. Turn on web search', description: 'Flip the globe on when you need fresh information from the internet (news, prices, dates). It stays on until you turn it off.', target: '[data-tour="chat-web"]' },
      { title: '6. Switch to Deep mode', description: 'Deep mode tells the assistant to think harder, plan more carefully, and skip clarifying questions. Great for research and complex prompts.', target: '[data-tour="chat-deep"]' },
      { title: '7. Type and send', description: 'Write your question here. Shift+Enter for a new line, Enter to send.', target: '[data-tour="chat-input"]' },
    ],
    outro:
      'The assistant has read-only access to your connected mailboxes and respects all your permissions. It never sends mail or modifies your inbox without an explicit confirmation step.',
    routes: ['/ai-chat'],
    keywords: ['chat', 'assistant', 'ask', 'question', 'voice', 'microphone', 'capacity'],
  },
  {
