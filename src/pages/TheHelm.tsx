...
const CAL_OFFHOURS_BOTTOM_TOP = CAL_GRID_HEIGHT;
const CAL_OFFHOURS_BOTTOM_HEIGHT = 0;
        ...
        return (
          ...
          >
            ...
            {events.map((ev) => {
              ...
              const isOverlap = overlappingIds.has(ev.id) && !isGhost;
