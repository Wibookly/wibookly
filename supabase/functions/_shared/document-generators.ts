// Shared document-generation library for the Nikkore Inbox agent.
...
export async function generateXlsx(input: XlsxInput): Promise<GeneratedFile> {
  ...
  wb.creator = 'Nikkore Inbox Agent';
  wb.created = new Date();
...
export async function generatePptx(input: PptxInput): Promise<GeneratedFile> {
  ...
  if (input.title) {
    ...
    titleSlide.addText('Generated by Nikkore Inbox Agent', {
